<div class="modal-header">
    <h5 class="modal-title" id="exampleModalLabel">Brand Bulk Upload</h5>
...
<div class="modal-body">
    <form class="ajax-form" id="uploadForm" action="{{ route('admin.common-module.brand.bulk.upload') }}" method="post" enctype="multipart/form-data">
        @csrf
