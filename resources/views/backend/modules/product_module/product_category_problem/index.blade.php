...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h3>Product Category Problem: {{$pc->name}}</h3>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-right">
                        ...
                        <li class="breadcrumb-item"><a
                                ...
                                Managment</a></li>
                        <li class="breadcrumb-item active">Product Category Problem</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="row">
                <div class="col-12">
                    <a class="btn btn-primary my-3 btn btn-outline-dark float-right"
                       data-content="{{route('admin.product-module.product-category-problem.modal.create',['pc_id'=>$pc->id])}}"
    ...
    <script>
        ...
        $(function () {
            $('#dataGrid').DataTable({
                ...
                serverSide: true,
                searching: true,
                ajax: "{{ route('admin.product-module.product-category-problem.problem.data',['id'=>$pc->id]) }}",
                order: [
                    [0, 'Desc']
                ],
                columns: [
